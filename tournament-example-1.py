...
from tournament.agents.axelrod_first import Davis, Graaskamp, Shubik, SteinAndRapoport, Grudger


if __name__ == "__main__":
    tournament = RoundRobinTournament([TitForTat, Random, AllC, AllD, Davis, Graaskamp, Shubik, SteinAndRapoport, Grudger, OmegaTFT, Pavlov, TFTT, TTFT, GradualTFT, GenerousTFT])
